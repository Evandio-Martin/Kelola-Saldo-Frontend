    ...
    <div className="space-y-6">
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              <label className="flex flex-col gap-2 text-sm font-medium text-neutral-600 dark:text-neutral-300">
                ...
                <select
                  ...
                  className="rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-sm text-neutral-900 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100"
                >
              ...
              <label className="flex flex-col gap-2 text-sm font-medium text-neutral-600 dark:text-neutral-300">
                {copy.search}
                <div className="flex items-center gap-2 rounded-xl border border-neutral-300 bg-white px-4 py-2.5 focus-within:border-sky-500 focus-within:ring-2 focus-within:ring-sky-500/20 dark:border-neutral-700 dark:bg-neutral-950">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <article className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
          ...
          <p className="mt-3 text-3xl font-semibold text-sky-600 dark:text-sky-300">
