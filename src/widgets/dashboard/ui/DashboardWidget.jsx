    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950 md:flex-row md:items-end md:justify-between">
        <div className="space-y-3">
          <span className="inline-flex w-fit items-center rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold tracking-wide text-sky-700 uppercase dark:bg-sky-500/15 dark:text-sky-200">
            {copy.badge}
          </span>
          <div>
        ...
        <div className="flex flex-col gap-3 sm:items-end">
          ...
          <Link to="/transactions" className="inline-flex items-center justify-center rounded-xl bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-700">
